  ...
  return (
    <>
      ...
      <main>
        ...
        {/* About Section */}
        <section className="bg-white py-2 lg:py-16">
          <div className="container">
            <h1 className="text-3xl lg:text-5xl text-blue-500 font-semibold mb-4 text-center">
              About
            </h1>
            ...
            <div className="bg-blue-50 p-6 lg:p-12 rounded-lg">
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-12 items-center">
                ...
                <div className="lg:text-left mb-8 lg:mb-0">
                  <h2 className="text-red-500 font-bold mb-4 lg:text-2xl">EARLY BEGINNINGS</h2>
                  <h3 className="text-3xl lg:text-[36px] leading-tight lg:leading-tight font-semibold mb-4 text-blue-500">Started In <span className="text-red-500">1999</span> By 3 Enterprising Engineers, Today A <span className="text-red-500">LEADING PLAYER</span></h3>
                ...
                <div className="flex justify-center items-center mb-8 lg:mb-0">
                  <img 
                    ...
                    className="hidden lg:block min-w-[210px] max-w-[210px] w-full"
                  />
                  <img 
        ...
        <section className="py-2 lg:py-16">
          <div className="container grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-12 items-center">
            <div>
        ...
        <section className="py-2 lg:py-16">
          ...
          <div className="container items-center">
            <p className="text-medium mb-4 text-center px-4 lg:px-14 py-4">
        ...
        <section className="bg-white py-2 lg:py-16">
          <div className="container">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-12 mb-4">
              ...
              <div className="flex justify-center items-center">
                ...
                />
                <img 
                  src="/about/mobile/group pic.png"
                  alt="Team Group Photo"
        ...
        <div className="px-6 py-4 lg:px-10 lg:py-12">
          <ContactCard />
        </div>
      </main>
      <Footer />
