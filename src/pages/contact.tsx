				...
				<section className="py-8 lg:py-16">
					<div className="mb-8">
						<div className="flex flex-col lg:flex-row lg:justify-between lg:items-start">
							<div>
								<span className="text-red-500 font-bold text-xs lg:text-xl tracking-widest">GET STARTED</span>
								<h1 className="text-blue-500 text-2xl lg:text-6xl font-bold mt-2">
							...
							<div className="lg:w-2/3 lg:pl-12">
								...
								<div className="space-y-6 text-sm lg:text-base">
									<a href="tel:+918329008308" className="flex items-center gap-3 hover:opacity-90">
										<svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="flex-shrink-0 lg:w-6 lg:h-6">
									...
									<div className="flex items-start gap-3">
										<svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="flex-shrink-0 mt-1 lg:w-6 lg:h-6">
							...
							<div className="grid md:grid-cols-2 gap-8">
								...
								<h2 className="text-[#0066CC] text-2xl md:text-4x lg:text-3xl font-bold mb-4">Head Office (Goa)</h2>
									<div>
										...
										<p>Fluidmac Hose Industries</p>
										<p>Plot No.8, Kakoda Industrial Estate, Curchorem, Goa-403706, India</p>
									</div>
									<div>
