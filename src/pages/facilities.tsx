...
export default function FacilitiesPage() {
  return (
    <>
      ...
      <main>
        {/* Hero Section */}
        <section className="bg-white py-12 lg:py-24 text-center">
          <div className="container">
            <h1 className="text-3xl lg:text-6xl text-blue-500 font-semibold mb-4">
              Facilities
            </h1>
            <p className="text-lg lg:text-2xl mb-12 lg:mb-20 mx-auto max-w-4xl">
        ...
        <section className="py-12 lg:py-24">
          <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12 max-w-7xl mx-auto px-4">
            ...
            <div className="lg:w-1/4">
              ...
              />
              <img
                src="/facilities/mobile/crimping_machine_left.png"
                alt="Hose flushing and cleaning station 1"
                className="w-full rounded-lg lg:hidden"
              />
            </div>
...
UNIFLEX HM480 ¼” to 3 ”ID Spiral Hose & up to 10” industrial hoses 
HM350 ¼” to 2 ½” ID Spiral Hose & upto 5” industrial hoses 
FINN power P32X - ¼” to 2” ID Spiral Hose 
Techmaflex S Crimp 240 PE38 
Techmaflex S Crimp 240 EVO 
        ...
        <section className="py-12 lg:py-24">
          <div className="container text-center">
            ...
            <p className="text-lg lg:text-xl mb-12 max-w-4xl mx-auto">
        ...
        <section className="py-12 lg:py-24">
          <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12 max-w-7xl mx-auto px-4">
            ...
            <div className="lg:w-1/4">
              ...
              />
              <img
                src="/facilities/mobile/roll_making_machine.png"
                alt="Hose flushing and cleaning station 1"
                className="w-full rounded-lg lg:hidden"
              />
            </div>
        ...
        <section className="py-12 lg:py-24">
          <div className="container">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl lg:text-4xl text-blue-500 font-bold mb-4">
                  CNC Tube Bending Machine
                </h2>
                <p className="text-lg">
        ...
        <section className="py-12 lg:py-24">
          <div className="container text-center">
            ...
            <p className="text-lg lg:text-xl mx-auto max-w-4xl mb-12">
            ...
            <p className="text-lg lg:text-xl mx-auto max-w-4xl mb-16">
